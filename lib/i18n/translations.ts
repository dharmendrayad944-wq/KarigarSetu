...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    pillarIncomeTitle: "Market-Based Price Discovery",
    pillarIncomeDesc: "Suggests an indicative price range derived from comparable products retrieved from approved market data sources. The final price is always decided by the artisan.",
    ...
    fieldPriceRange: "Recommended Market Range (₹)",
    pricingRationaleTitle: "Market Price Analysis",
    pricingRationaleSubtitle: "Derived from comparable marketplace listings. Final selling price is chosen by the artisan.",
  ...
  hi: {
    ...
    pillarIncomeTitle: "बाज़ार-आधारित मूल्य खोज",
    pillarIncomeDesc: "मान्यता प्राप्त बाज़ार स्रोतों से तुलनीय उत्पादों के आधार पर अनुशंसित मूल्य सीमा सुझाता है। अंतिम मूल्य हमेशा कारीगर तय करता है।",
    ...
    fieldPriceRange: "अनुशंसित बाज़ार मूल्य सीमा (₹)",
    pricingRationaleTitle: "बाज़ार मूल्य विश्लेषण",
    pricingRationaleSubtitle: "तुलनीय बाज़ार उत्पादों के आधार पर। अंतिम बिक्री मूल्य कारीगर तय करता है।",
